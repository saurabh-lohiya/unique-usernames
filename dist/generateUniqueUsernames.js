import { quirkyAdjectives, quirkyNouns, marvelNouns, cartoonNouns, animeNouns, nfswAdjectives, } from "./constant";
...
export function generateUniqueUsername({ adjectiveGenre = "quirky", nounGenre = "quirky", serial, separator = false, shouldCapitalize = false, isUsernameTaken = () => false, } = {}) {
    ...
    do {
        ...
        const randomNumber = serial !== null && serial !== void 0 ? serial : Math.floor(Math.random() * 1000000); // Support up to 1M users
